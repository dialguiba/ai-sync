...
func TestListShowsGeneratedFilesWithoutWritingThem(t *testing.T) {
	...
	for _, want := range []string{
		...
		".kiro/skills/playwright-cli/SKILL.md",
	} {
		if !strings.Contains(out, want+"\n") {
...
func TestSyncGeneratesClaudeCodexAndKiroOutputs(t *testing.T) {
	...
	assertFileContains(t, filepath.Join(dir, ".kiro/skills/playwright-cli/SKILL.md"), "Playwright CLI")
	assertFileContains(t, filepath.Join(dir, ".kiro/skills/playwright-cli/SKILL.md"), "Generated by ai-sync")
	assertFileContains(t, filepath.Join(dir, ".kiro/skills/playwright-cli/references/checklist.md"), "# Checklist")
	assertFileContains(t, filepath.Join(dir, ".kiro/skills/playwright-cli/.ai-sync-manifest"), "SKILL.md")
	assertFileContains(t, filepath.Join(dir, ".kiro/skills/playwright-cli/.ai-sync-manifest"), "references/checklist.md")
...
func TestSyncIsIdempotent(t *testing.T) {
	...
	first := snapshotFiles(t, dir, []string{
		...
		".kiro/skills/playwright-cli/SKILL.md",
		".kiro/skills/playwright-cli/.ai-sync-manifest",
	})
...
func TestSyncPrunesStaleGeneratedSkillOutputs(t *testing.T) {
	...
	if !strings.Contains(out, "removed .agents/skills/playwright-cli/SKILL.md") || !strings.Contains(out, "removed .kiro/powers/playwright-cli/POWER.md") || !strings.Contains(out, "removed .kiro/skills/playwright-cli/SKILL.md") {
